System.register(['angular2/core', '../../model/pelicula', 'angular2/router', '../../services/peliculas/peliculas.service'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            ...
            CrearPeliculaComponent = (function () {
                function CrearPeliculaComponent(_peliculasService, _router, _routeParams) {
                    ...
                    this.tituloComponente = "Crear película";
                    this.TituloPelicula = "";
                }
                ...
                CrearPeliculaComponent.prototype.ngOnInit = function () {
                    ...
                    this.nuevaPelicula = new pelicula_1.Pelicula(0, this._routeParams.get("titulo"), this._routeParams.get("director"), anio);
                };
