System.register(['angular2/core', '../../services/peliculas/peliculas.service', 'angular2/router'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            PeliculasListComponent = (function () {
                ...
                PeliculasListComponent.prototype.onShowHide = function (valor) {
                    this.mostrarDatos = valor;
                };
                PeliculasListComponent.prototype.onCambiarPelicula = function (valor) {
                    this.pelicula = valor;
                    this.peliculaSeleccionada = valor;
                };
                PeliculasListComponent.prototype.estaSeleccionada = function (valor) {
